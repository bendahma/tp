            ...
            <div class="w-full">
                ...
                @csrf
                    ...
                    <div class="mt-4">
                        ...
                        <x-input type="text"  id="name" name="name"  class="block w-full"  value="{{ old('name') }}"  required  autofocus/>
                    </div>

                    <div class="mt-4">
                        <x-label for="name" :value="__('Username')"/>
                        <x-input type="text"  id="username" name="username"  class="block w-full"  value="{{ old('username') }}"  />
                    </div>
