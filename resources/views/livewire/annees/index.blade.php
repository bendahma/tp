<div class="">
   ...
   <div class="flex justify-between items-center w-full">
      <div class="flex gap-x-3">
         ...
         <div class="">
            <a data-tooltip-target="tooltip-default" href="{{route('annee.create')}}"
                  ...
                  <td class="px-4 py-3 text-sm">
                     <div class="flex justify-evenly items-center ">
                        <div class="flex justiy-evenly gap-x-2">
                           <a href="{{route('annee.edit',$annee->id)}}"> <i
                                 class="fas fa-edit text-blue-600 text-lg"></i> </a>
                           <form method="post" action="{{route('annee.destroy',$annee->id)}}" class="">
                              @csrf
                              @method('DELETE')
                              <button type="submit">
