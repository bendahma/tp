<div class="">
   ...
   <div class="flex justify-between items-center w-full">
      <div class="flex gap-x-3">
         ...
         <div class="">
            <a data-tooltip-target="tooltip-default" href="{{route('niveau.create')}}"
            ...
            <tbody class="bg-white divide-y">
                  ...
                  <td class="px-4 py-3 text-sm">
                     <div class="flex justify-evenly items-center ">
                        <div class="flex justiy-evenly gap-x-2">
                           <a href="{{route('niveau.edit',$niveau->id)}}"> <i
                                 class="fas fa-edit text-blue-600 text-lg"></i> </a>
                           <form method="post" action="{{route('niveau.destroy',$niveau->id)}}" class="">
                              @csrf
                              @method('DELETE')
                              <button type="submit">
               ...
               <tr>
                  <td colspan="3" class="w-full">
                     <span class="w-full justify-center font-bold h-10 text-center"> Aucun niveau scolaire exites pour
                        le moments </span>
                  </td>
               </tr>
               @endforelse
